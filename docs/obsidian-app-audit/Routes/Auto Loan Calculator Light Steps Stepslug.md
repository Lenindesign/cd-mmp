...
route: "/auto-loan-calculator/light-steps/:stepSlug"
module: "Finance and Calculator"
component: "AllInOnePaymentCalculatorLightStepsPage"
---

# /auto-loan-calculator/light-steps/:stepSlug
Module: [[Modules/Finance and Calculator|Finance and Calculator]]
Component: `AllInOnePaymentCalculatorLightStepsPage`
Source: `src/pages/AllInOnePaymentCalculatorPage/AllInOnePaymentCalculatorLightStepsPage.tsx`
## Audit Focus
