...
export const Welcome: Story = {
  ...
  render: () => (
    <div style={styles.page}>
      {/* Header */}
      <header style={{ ...styles.header, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
        {/* Version Badge - Above logo, left aligned */}
        <div style={{ ...styles.badge, marginBottom: 'var(--spacing-4)' }}>
        ...
        {/* Car and Driver Logo */}
        <svg viewBox="0 0 1364 263" style={{ display: 'block', width: '320px', height: 'auto', marginBottom: 'var(--spacing-6)' }} xmlns="http://www.w3.org/2000/svg">
