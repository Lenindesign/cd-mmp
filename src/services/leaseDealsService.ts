...
const LEASE_DEAL_DEFS: LeaseDealDef[] = [
  ...
  leaseDeal({ make: 'Chevrolet', model: 'Bolt EV', monthly: 249, dueAtSigning: 1999, mileage: '12,000 mi/yr', programName: 'Chevrolet Bolt EV Lease Deal', trims: ['LT', 'Premier'] }),
  ...
  leaseDeal({ make: 'Ford', model: 'Maverick', monthly: 309, dueAtSigning: 2699, mileage: '10,500 mi/yr', programName: 'Ford Maverick Lease Deal', programDescription: 'Lease a 2026 Maverick Hybrid XL for 36 months. $2,699 due at signing through Ford Motor Credit.', trims: ['XL', 'XLT'] }),
  leaseDeal({ make: 'Ford', model: 'Escape', monthly: 289, dueAtSigning: 2499, programName: 'Ford Escape Lease Deal', trims: ['Active', 'ST-Line'] }),
  ...
  leaseDeal({ make: 'Ford', model: 'Mustang', monthly: 419, dueAtSigning: 3499, programName: 'Ford Mustang Lease Deal', trims: ['EcoBoost', 'GT'] }),

  // Honda
  leaseDeal({ make: 'Honda', model: 'CR-V', monthly: 369, dueAtSigning: 3499, programName: 'Honda CR-V Lease Deal', programDescription: 'Lease a 2026 CR-V LX for 36 months. $3,499 due at signing through Honda Financial Services.', trims: ['LX', 'EX'] }),
  ...
  leaseDeal({ make: 'Honda', model: 'HR-V', monthly: 269, dueAtSigning: 2399, mileage: '12,000 mi/yr', programName: 'Honda HR-V Lease Deal', programDescription: 'Lease a 2026 HR-V LX for 36 months. $2,399 due at signing through Honda Financial Services.', trims: ['LX', 'Sport'] }),
  ...
  leaseDeal({ make: 'Honda', model: 'Pilot', monthly: 419, dueAtSigning: 3799, programName: 'Honda Pilot Lease Deal', trims: ['Sport', 'EX-L'] }),
  leaseDeal({ make: 'Honda', model: 'Civic Hatchback', monthly: 309, dueAtSigning: 2699, programName: 'Honda Civic Hatchback Lease Deal', trims: ['LX', 'Sport'] }),

  // Toyota
  leaseDeal({ make: 'Toyota', model: 'Camry', monthly: 329, dueAtSigning: 2999, programName: 'Toyota Camry Lease Deal', programDescription: 'Lease a new Camry LE for 36 months through Toyota Financial Services. $2,999 due at signing.', trims: ['LE', 'SE'] }),
  ...
  leaseDeal({ make: 'Toyota', model: 'Corolla', monthly: 249, dueAtSigning: 2199, mileage: '12,000 mi/yr', programName: 'Toyota Corolla Lease Deal', programDescription: 'Lease a new Corolla LE for 36 months. $2,199 due at signing through Toyota Financial Services.', trims: ['LE', 'SE'] }),
  ...
  leaseDeal({ make: 'Toyota', model: 'bZ4X', monthly: 349, dueAtSigning: 2999, programName: 'Toyota bZ4X Lease Deal', trims: ['XLE', 'Limited'] }),
  ...
  leaseDeal({ make: 'Toyota', model: 'GR86', monthly: 339, dueAtSigning: 2999, programName: 'Toyota GR86 Lease Deal', trims: ['Base', 'Premium'] }),
  ...
  leaseDeal({ make: 'Hyundai', model: 'Sonata', monthly: 309, dueAtSigning: 2699, programName: 'Hyundai Sonata Hybrid Lease Deal', programDescription: 'Lease a new Sonata Hybrid SE for 36 months. $2,699 due at signing through Hyundai Motor Finance.', trims: ['SEL Hybrid', 'Limited Hybrid'] }),
  leaseDeal({ make: 'Hyundai', model: 'Santa Fe', monthly: 389, dueAtSigning: 3199, programName: 'Hyundai Santa Fe Hybrid Lease Deal', programDescription: 'Lease a 2026 Santa Fe Hybrid for 36 months. $3,199 due at signing through Hyundai Motor Finance.', trims: ['SEL Hybrid', 'Limited Hybrid'] }),
  ...
  leaseDeal({ make: 'Hyundai', model: 'Elantra', monthly: 239, dueAtSigning: 2099, programName: 'Hyundai Elantra Lease Deal', trims: ['SE', 'SEL'] }),
  ...
  leaseDeal({ make: 'Hyundai', model: 'Ioniq 6', monthly: 279, dueAtSigning: 2599, programName: 'Hyundai Ioniq 6 Lease Deal', trims: ['SE', 'SEL'] }),
  ...
  leaseDeal({ make: 'Kia', model: 'Telluride', monthly: 429, dueAtSigning: 3799, programName: 'Kia Telluride Lease Deal', trims: ['LX', 'S'] }),
  leaseDeal({ make: 'Kia', model: 'EV6', monthly: 319, dueAtSigning: 2999, programName: 'Kia EV6 Lease Special', trims: ['Light', 'Wind'] }),
  leaseDeal({ make: 'Kia', model: 'Forte', monthly: 219, dueAtSigning: 1899, mileage: '12,000 mi/yr', programName: 'Kia Forte Lease Deal', trims: ['LX', 'LXS'] }),

  // Nissan
  leaseDeal({ make: 'Nissan', model: 'Rogue', monthly: 349, dueAtSigning: 2799, programName: 'Nissan Rogue Lease Deal', programDescription: 'Lease a new Rogue S for 36 months. $2,799 due at signing through NMAC.', trims: ['S', 'SV'] }),
  leaseDeal({ make: 'Nissan', model: 'Altima', monthly: 319, dueAtSigning: 2599, mileage: '12,000 mi/yr', programName: 'Nissan Altima Lease Deal', programDescription: 'Lease a new Altima S for 36 months. $2,599 due at signing through NMAC.', trims: ['S', 'SV'] }),
  leaseDeal({ make: 'Nissan', model: 'Kicks', monthly: 229, dueAtSigning: 1999, mileage: '12,000 mi/yr', programName: 'Nissan Kicks Lease Deal', programDescription: 'Lease a new Kicks S for 36 months. $1,999 due at signing through NMAC.', trims: ['S', 'SV'] }),
  leaseDeal({ make: 'Nissan', model: 'Leaf', monthly: 259, dueAtSigning: 2299, programName: 'Nissan Leaf Lease Special', trims: ['S', 'SV Plus'] }),
  leaseDeal({ make: 'Nissan', model: 'Titan', monthly: 449, dueAtSigning: 3999, programName: 'Nissan Titan Lease Deal', trims: ['S', 'SV'] }),
  ...
  leaseDeal({ make: 'Mazda', model: 'CX-90', monthly: 469, dueAtSigning: 4199, programName: 'Mazda CX-90 Hybrid Lease Deal', trims: ['Select Hybrid', 'Preferred Hybrid'] }),
  leaseDeal({ make: 'Mazda', model: 'MX-5 Miata', monthly: 349, dueAtSigning: 2999, programName: 'Mazda MX-5 Miata Lease Deal', trims: ['Sport', 'Club'] }),
  leaseDeal({ make: 'Mazda', model: '3', monthly: 279, dueAtSigning: 2399, programName: 'Mazda3 Lease Event', trims: ['2.5 S', 'Select'] }),

  // Subaru
  leaseDeal({ make: 'Subaru', model: 'Crosstrek', monthly: 329, dueAtSigning: 2799, programName: 'Subaru Crosstrek Lease Deal', programDescription: 'Lease a 2026 Crosstrek Base for 36 months. $2,799 due at signing through Subaru Motors Finance.', trims: ['Base', 'Premium'] }),
  ...
  leaseDeal({ make: 'Subaru', model: 'Outback', monthly: 349, dueAtSigning: 2999, programName: 'Subaru Outback Lease Deal', trims: ['Base', 'Premium'] }),
  ...
  leaseDeal({ make: 'Subaru', model: 'BRZ', monthly: 339, dueAtSigning: 2999, programName: 'Subaru BRZ Lease Deal', trims: ['Premium', 'Limited'] }),
  ...
  leaseDeal({ make: 'Volkswagen', model: 'Atlas', monthly: 389, dueAtSigning: 3499, programName: 'Volkswagen Atlas Lease Deal', trims: ['SE', 'SE w/Technology'] }),
  ...
  // BMW
  leaseDeal({ make: 'BMW', model: '3 Series', monthly: 429, dueAtSigning: 3999, programName: 'BMW 3 Series Lease Deal', trims: ['330i', '330i xDrive'] }),
  ...
  leaseDeal({ make: 'BMW', model: 'iX', monthly: 699, dueAtSigning: 6499, programName: 'BMW iX Lease Deal', trims: ['xDrive50', 'M60'] }),
  ...
  // Mercedes-Benz
  leaseDeal({ make: 'Mercedes-Benz', model: 'C-Class', monthly: 479, dueAtSigning: 4299, programName: 'Mercedes-Benz C-Class Lease Deal', trims: ['C 300', 'C 300 4MATIC'] }),
  ...
  // Audi
  leaseDeal({ make: 'Audi', model: 'A4', monthly: 439, dueAtSigning: 3999, programName: 'Audi A4 Lease Deal', trims: ['Premium', 'Premium Plus'] }),
  ...
  leaseDeal({ make: 'Audi', model: 'Q4 e-tron', monthly: 529, dueAtSigning: 4799, programName: 'Audi Q4 e-tron Lease Deal', trims: ['50 quattro', 'Premium Plus'] }),
  ...
  // Tesla
  leaseDeal({ make: 'Tesla', model: 'Model 3', monthly: 349, dueAtSigning: 2999, programName: 'Tesla Model 3 Lease Deal', trims: ['Long Range', 'Performance'] }),
  ...
  // Genesis
  leaseDeal({ make: 'Genesis', model: 'G70', monthly: 419, dueAtSigning: 3799, programName: 'Genesis G70 Lease Deal', trims: ['2.5T', '3.3T'] }),
  ...
  // Lexus
  leaseDeal({ make: 'Lexus', model: 'ES', monthly: 479, dueAtSigning: 4199, programName: 'Lexus ES Hybrid Lease Deal', trims: ['ES 300h', 'ES 300h Luxury'] }),
  ...
  // Volvo
  leaseDeal({ make: 'Volvo', model: 'XC90', monthly: 619, dueAtSigning: 5499, programName: 'Volvo XC90 Recharge Lease Deal', trims: ['B5 Core', 'T8 Plus'] }),
  ...
  leaseDeal({ make: 'Volvo', model: 'V90', monthly: 479, dueAtSigning: 4299, programName: 'Volvo V90 Cross Country Lease Deal', trims: ['Plus', 'Ultimate'] }),
  ...
  // Ram
  leaseDeal({ make: 'Ram', model: '1500', monthly: 469, dueAtSigning: 4199, programName: 'Ram 1500 Lease Deal', trims: ['Tradesman', 'Big Horn'] }),
  ...
  // GMC
  leaseDeal({ make: 'GMC', model: 'Sierra', monthly: 479, dueAtSigning: 4299, programName: 'GMC Sierra Lease Deal', trims: ['Pro', 'SLE'] }),
  ...
  // Mini
  leaseDeal({ make: 'Mini', model: 'Cooper Hardtop', monthly: 309, dueAtSigning: 2699, programName: 'MINI Cooper Hardtop Lease Deal', trims: ['Cooper', 'Cooper S'] }),
