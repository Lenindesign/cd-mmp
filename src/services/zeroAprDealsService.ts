...
const DEAL_DEFINITIONS: ZeroAprDealDef[] = [
  ...
  // Toyota
  zeroAprDeal({ make: 'Toyota', model: 'Camry', term: '60 months', programName: 'Toyota Special Finance Deal', programDescription: 'Toyota Financial Services has 0% APR for 60 months on the popular Camry sedan. College graduate rebates may be available at participating dealers.', targetAudience: 'Tier 1+ credit customers through Toyota Financial Services', trims: ['LE', 'SE', 'XLE', 'XSE'], eligibilityTags: ['collegeGrad'] }),
  zeroAprDeal({ make: 'Toyota', model: 'RAV4', term: '48 months', programName: 'Toyota RAV4 Spring Special', programDescription: '0% APR financing for 48 months on America\'s best-selling SUV. Limited-time deal through Toyota Financial Services.', trims: ['LE', 'XLE', 'XLE Premium'] }),
  ...
  zeroAprDeal({ make: 'Toyota', model: 'Highlander', term: '48 months', programName: 'Toyota Highlander 0% APR Deal', trims: ['LE', 'XLE', 'Limited'] }),
  ...
  // Honda
  zeroAprDeal({ make: 'Honda', model: 'CR-V', term: '60 months', programName: 'Honda Dream Deal', programDescription: 'Honda has 0% APR for 60 months on the CR-V, the benchmark compact SUV. Available through Honda Financial Services.', targetAudience: 'Well-qualified buyers with 700+ credit score', trims: ['LX', 'EX', 'EX-L'] }),
  ...
  // Ford
  zeroAprDeal({ make: 'Ford', model: 'F-150', term: '72 months', programName: 'Ford Truck Season', programDescription: 'Ford has 0% APR for 72 months on select F-150 models during Truck Season. Military appreciation deals may be available.', targetAudience: 'Well-qualified buyers financing through Ford Credit', trims: ['XL', 'XLT', 'Lariat'], eligibilityTags: ['military'] }),
  zeroAprDeal({ make: 'Ford', model: 'Escape', term: '60 months', programName: 'Ford Escape 0% APR Deal', targetAudience: 'Well-qualified buyers financing through Ford Credit', trims: ['Active', 'ST-Line', 'Platinum'] }),
  ...
  // Kia
  zeroAprDeal({ make: 'Kia', model: 'Seltos', term: '60 months', programName: 'Kia Spring Clearance', programDescription: '0% APR for 60 months on the versatile Kia Seltos. First responder appreciation deals may be available through Kia Finance America at participating dealers.', targetAudience: 'Well-qualified buyers through Kia Finance America', trims: ['LX', 'S', 'EX'], eligibilityTags: ['firstResponder'] }),
