              ...
              {dealChunks.map((chunk, chunkIndex) => (
                <Fragment key={`truck-segment-${chunkIndex}`}>
                  <div className="truck-deals-page__segment">
                    <div className="truck-deals-page__main">
                      <section className="truck-deals-page__section">
                        <div className="truck-deals-page__grid" role="list">
                          {chunk.map((deal, i) => {
                ...
                <div className="truck-deals-page__faq-list">
                  {FAQ_DATA.map((faq, i) => (
                    <div key={i} className={`truck-deals-page__faq-item ${expandedFaqIndex === i ? 'truck-deals-page__faq-item--expanded' : ''}`}>
                      <button type="button" className="truck-deals-page__faq-question" onClick={() => setExpandedFaqIndex(expandedFaqIndex === i ? null : i)} aria-expanded={expandedFaqIndex === i}>
