...
interface VehiclePageVariantBProps {
  variant: 'v1b' | 'v2b' | 'v3b' | 'v4b' | 'v5b';
}

const VARIANTS = ['v1b', 'v2b', 'v3b', 'v4b', 'v5b'] as const;

// Display labels for each variant (position-based: V1/5, V2/5, etc.)
const getVariantLabel = (index: number, total: number) => {
  return `Pricing CTA V${index + 1}/${total}`;
};

const VehiclePageVariantB = ({ variant }: VehiclePageVariantBProps) => {
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <span style={{ padding: '8px 16px', minWidth: '150px', textAlign: 'center' }}>
      ...
      <main className="main">
        ...
        {/* PRICING CTA SECTION - This is what we're testing */}
        <PricingCTAComponent
