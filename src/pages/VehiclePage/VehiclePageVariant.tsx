...
const getVariantLabel = (index: number, total: number) => {
  return `CTA Variant V${index + 1}/${total}`;
};

const VehiclePageVariant = ({ variant }: VehiclePageVariantProps) => {
  ...
  return (
    <>
      ...
      <main className="main">
        <HeroComponent vehicle={vehicleData} />
...
export default VehiclePageVariant;
