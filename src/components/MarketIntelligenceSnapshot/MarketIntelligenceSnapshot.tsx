...
interface MarketIntelligenceSnapshotProps {
  ...
  /** Keeps the current presentation as the default while enabling a decision-support comparison in Storybook. */
  experience?: MarketSnapshotExperience;
}

export type MarketSnapshotVariant = 'full' | 'compact';
export type MarketSnapshotExperience = 'current' | 'decision-support';
