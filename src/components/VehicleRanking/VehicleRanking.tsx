                ...
                {(vehicle.editorsChoice || vehicle.tenBest || vehicle.evOfTheYear) && (
                  <div className="vehicle-ranking__card-accolades">
                    {vehicle.editorsChoice && (
                      <div className="vehicle-ranking__card-accolade" title="Editors' Choice">
                    ...
                    {vehicle.tenBest && (
                      <div className="vehicle-ranking__card-accolade" title="10Best">
                        <img 
                    ...
                    {vehicle.evOfTheYear && (
                      <div className="vehicle-ranking__card-accolade" title="EV of the Year">
                        <img 
