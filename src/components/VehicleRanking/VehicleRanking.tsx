        ...
        <div className="vehicle-ranking__grid">
          {displayVehicles.map((vehicle) => (
            ...
            >
              ...
              {/* Accolade Badges - Editors' Choice, 10Best, EV of the Year - Positioned at card level for tooltip visibility */}
              {(vehicle.editorsChoice || vehicle.tenBest || vehicle.evOfTheYear) && (
                <div className="vehicle-ranking__card-accolades" onClick={(e) => e.preventDefault()}>
                  {vehicle.editorsChoice && (
                    <div className="vehicle-ranking__card-accolade" data-tooltip="Editors' Choice">
                  ...
                  {vehicle.tenBest && (
                    <div className="vehicle-ranking__card-accolade" data-tooltip="10BEST">
                      <img 
                  ...
                  {vehicle.evOfTheYear && (
                    <div className="vehicle-ranking__card-accolade" data-tooltip="EV of the Year">
                      <img 
