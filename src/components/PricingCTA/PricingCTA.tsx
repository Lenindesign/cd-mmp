...
const getSampleListings = (_make: string, _model: string, msrp: number) => [
  {
    ...
    mileage: 18500,
    image: 'https://hips.hearstapps.com/mtg-prod/66466c0b6e89190008af75b2/005-2025-chevrolet-trax-exterior-front-view.jpg',
    badge: 'Great Price',
  ...
  },
  {
    ...
    mileage: 32000,
    image: 'https://hips.hearstapps.com/mtg-prod/66466c139cbba1000852d79d/008-2025-chevrolet-trax-exterior-front-view.jpg',
    badge: 'One Owner',
    dealer: 'CarMax Doral',
  },
  {
    ...
    mileage: 24000,
    image: 'https://hips.hearstapps.com/mtg-prod/66466c246e89190008af75b5/014-2025-chevrolet-trax-exterior-rear-view.jpg',
    badge: 'No Accidents',
