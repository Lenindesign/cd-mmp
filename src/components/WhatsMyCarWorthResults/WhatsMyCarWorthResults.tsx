...
const WhatsMyCarWorthResults = ({
  ...
  const vehicleImage = useMemo(() => {
    ...
    return vehicle?.image || 'https://hips.hearstapps.com/mtg-prod/679d37b47ff34400082301e7/19-2025-honda-accord-front-view.jpg';
    ...
    return [
      {
        ...
        interiorColor: 'Black',
        msrp: 32190,
        image: 'https://hips.hearstapps.com/mtg-prod/65a4c354fc591800081603fc/3-2024-kia-k5-front-view.jpg',
        mileage: 0,
        isNew: true,
      ...
      },
      {
        ...
        interiorColor: 'Gray',
        msrp: 24890,
        image: 'https://hips.hearstapps.com/mtg-prod/65a4ab44cd06f600080e4953/14-2024-kia-forte-front-view.jpg',
        mileage: 18420,
        isNew: false,
      ...
      },
      {
        ...
        interiorColor: 'Red',
        msrp: 34090,
        image: 'https://hips.hearstapps.com/mtg-prod/690bee134ffec60002725d25/010-2025-kia-ev6.jpg',
        mileage: 0,
        isNew: true,
        dealer: 'Kendall Kia',
        distance: 12.1,
    ...
    <div className={`whats-my-car-worth-results whats-my-car-worth-results--${variant}`}>
      ...
      <section className="elot-for-sale">
        ...
        <div className="elot-for-sale__carousel-wrapper">
          ...
          <div className="elot-for-sale__carousel">
            {[
              { id: 'el1', year: 2026, make: 'Honda', model: 'CR-V', trim: 'EX-L AWD', price: 38150, image: 'https://hips.hearstapps.com/mtg-prod/685edb52f9d75b00021b1e55/07-2026-honda-cr-v-trailsport.jpg', certified: true, goodPrice: true },
              { id: 'el2', year: 2026, make: 'Honda', model: 'CR-V', trim: 'Sport', price: 33550, image: 'https://hips.hearstapps.com/mtg-prod/680c099a59ad1f00089429b2/008-2026-honda-cr-v-first-look.jpg', certified: true, goodPrice: true },
              { id: 'el3', year: 2026, make: 'Honda', model: 'CR-V', trim: 'Touring', price: 41550, image: 'https://hips.hearstapps.com/mtg-prod/685edc61b46e00000219aa39/01-2026-honda-cr-v-trailsport.jpg', certified: false, goodPrice: true },
              { id: 'el4', year: 2026, make: 'Honda', model: 'CR-V', trim: 'Sport-L', price: 36100, image: 'https://hips.hearstapps.com/mtg-prod/685edc6a171ad600026f197c/04-2026-honda-cr-v-trailsport.jpg', certified: true, goodPrice: false },
              { id: 'el5', year: 2026, make: 'Honda', model: 'CR-V', trim: 'EX', price: 35250, image: 'https://hips.hearstapps.com/mtg-prod/685edc173f5dd40002189d2a/09-2026-honda-cr-v-trailsport.jpg', certified: true, goodPrice: true },
              { id: 'el6', year: 2026, make: 'Honda', model: 'CR-V', trim: 'Hybrid Sport-L', price: 39850, image: 'https://hips.hearstapps.com/mtg-prod/685edbf6b46e00000219aa37/08-2026-honda-cr-v-trailsport.jpg', certified: false, goodPrice: true },
              { id: 'el7', year: 2026, make: 'Honda', model: 'CR-V', trim: 'LX', price: 31250, image: 'https://hips.hearstapps.com/mtg-prod/685edb52f9d75b00021b1e55/07-2026-honda-cr-v-trailsport.jpg', certified: true, goodPrice: true },
              { id: 'el8', year: 2026, make: 'Honda', model: 'CR-V', trim: 'Sport Hybrid', price: 37450, image: 'https://hips.hearstapps.com/mtg-prod/680c099a59ad1f00089429b2/008-2026-honda-cr-v-first-look.jpg', certified: true, goodPrice: true },
            ].map((car) => (
      ...
      <section className="elot-section">
        ...
        <div className="elot-section__carousel">
          {[
            { id: 'e1', year: 2025, make: 'Hyundai', model: 'Sonata', trim: 'SEL', price: 29550, image: 'https://hips.hearstapps.com/mtg-prod/65a4c354fc591800081603fc/3-2024-kia-k5-front-view.jpg', mileage: 0, isNew: true },
            { id: 'e2', year: 2024, make: 'Toyota', model: 'Camry', trim: 'SE', price: 27890, image: 'https://hips.hearstapps.com/mtg-prod/679d37b47ff34400082301e7/19-2025-honda-accord-front-view.jpg', mileage: 15600, isNew: false },
            { id: 'e3', year: 2025, make: 'Honda', model: 'Accord', trim: 'Sport', price: 31078, image: 'https://hips.hearstapps.com/mtg-prod/66e8824d603db5000878f458/2025hondaaccordhybridfrontthreequarters.jpg', mileage: 0, isNew: true },
            { id: 'e4', year: 2024, make: 'Mazda', model: 'Mazda6', trim: 'Touring', price: 26500, image: 'https://hips.hearstapps.com/mtg-prod/65a4ab44cd06f600080e4953/14-2024-kia-forte-front-view.jpg', mileage: 22100, isNew: false },
            { id: 'e5', year: 2025, make: 'Nissan', model: 'Altima', trim: 'SV', price: 28790, image: 'https://hips.hearstapps.com/mtg-prod/690bee134ffec60002725d25/010-2025-kia-ev6.jpg', mileage: 0, isNew: true },
          ].map((car) => (
      ...
      <section className="content-recirc content-recirc--secondary">
        ...
        <div className="content-recirc__grid">
          {[
            { title: '10 Best Used Cars Under $20,000', category: 'Buying Guide', image: 'https://hips.hearstapps.com/mtg-prod/679d37b47ff34400082301e7/19-2025-honda-accord-front-view.jpg' },
            { title: 'How to Negotiate the Best Trade-In Value', category: 'Tips', image: 'https://hips.hearstapps.com/mtg-prod/679d37b47ff34400082301e7/19-2025-honda-accord-front-view.jpg' },
            { title: 'What to Know Before Trading In Your Car', category: 'Buying Guide', image: 'https://hips.hearstapps.com/mtg-prod/679d37b47ff34400082301e7/19-2025-honda-accord-front-view.jpg' },
          ].map((article, index) => (
