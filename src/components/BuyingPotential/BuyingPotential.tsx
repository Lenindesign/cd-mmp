...
import { ChevronDown, Check, ArrowRight, MapPin, Wallet } from 'lucide-react';
...
import TradeInEstimateModal, { type TradeInEstimateCondition } from '../TradeInEstimateModal';
...
const BuyingPotential = ({
  ...
  vehicleImage = 'https://hips.hearstapps.com/mtg-prod/66c5ee7c8a192c000814f46b/suvs-0029-2025-chevrolet-trax.png',
  ...
  const [tradeInCondition, setTradeInCondition] = useState<TradeInEstimateCondition>('average');
  ...
  return (
    <section className="buying-potential">
      ...
      <TradeInEstimateModal
        ...
        initialVehicle={tradeInVehicle}
        initialMileage={tradeInMileage}
        initialCondition={tradeInCondition}
        onClose={() => setIsTradeInModalOpen(false)}
        onApply={(estimate) => {
          setIncludeTradeIn(true);
          setTradeInAmount(estimate.value);
          setTradeInVehicle(estimate.vehicle);
          setTradeInMileage(estimate.mileage);
          setTradeInCondition(estimate.condition);
