          ...
          <div className="exit-modal__visual-content">
            ...
            <div className="exit-modal__logo">
              <svg viewBox="0 0 1364 263" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* C */}
                <path className="exit-modal__logo-letter" fill="#FFFFFF" d="M76.91 198.564c0 7.861-2.052 13.33-8.888 13.33-7.176 0-9.57-4.787-9.57-13.33V62.862c0-8.887 2.05-12.647 9.23-12.647 7.176 0 9.228 4.445 9.228 12.647v39.308h55.716V60.466c0-33.495-15.038-59.473-60.158-59.473H62.213C16.408.993 0 29.705 0 66.282v129.207c0 38.966 15.04 67.334 62.554 67.334h9.914c44.435 0 60.158-30.42 60.158-62.554v-52.635H76.91z"/>
                {/* A */}
                <path className="exit-modal__logo-letter" fill="#FFFFFF" d="M217.63 258.722h54.694l-35.55-254.31h-69.39l-32.473 254.31h48.88l3.76-37.259h25.979zM200.54 93.968l7.862 77.248H192.68z"/>
                {/* R */}
                <path className="exit-modal__logo-letter" fill="#FFFFFF" d="M334.666 48.162h8.205c7.52 0 9.229 3.076 9.229 11.966v34.178c0 8.89-3.079 12.31-10.255 12.31h-7.18zm0 106.308h7.861c7.52 0 9.573 3.76 9.573 12.304v73.835c0 9.228 2.049 15.038 4.442 18.113h55.716v-1.708c-1.708-3.42-3.416-8.89-3.416-18.46V154.47c0-19.146-12.648-29.397-22.218-33.158 9.91-4.445 22.218-15.04 22.218-38.625V49.186c0-30.077-17.09-44.774-42.045-44.774h-88.53v254.31h56.399z"/>
                {/* Top bar */}
                <path className="exit-modal__logo-bar" d="M428.499 64.016h166.27V4.609H428.5z" fill="#FFFFFF"/>
                {/* Bottom bar */}
                <path className="exit-modal__logo-bar" d="M428.499 258.039h166.27v-59.402H428.5z" fill="#FFFFFF"/>
                {/* AND (small text) */}
                <path className="exit-modal__logo-letter" fill="#FFFFFF" d="M453.644 183.665h19.441L468.018 78.982h-25.422L430.7 183.665h17.907l1.38-15.34h10.11zm-6.856-70.79 3.476 35.957h-6.354zm32.232-33.893v104.683h17.907V129.07l12.271 54.594h18.158V78.982h-17.658v50.651l-10.644-50.651zm57.382 104.683h29.679c12.145 0 18.532-7.742 18.532-24.063V102.06c0-16.743-7.138-23.08-18.658-23.08h-29.553zm19.819-85.263h3.724c2.755 0 3.632 1.825 3.632 6.05v52.76c0 4.36-.877 6.33-3.883 6.33h-3.473z"/>
                {/* D */}
                <path className="exit-modal__logo-letter" fill="#FFFFFF" d="M615.674 258.722h81.008c33.157 0 50.592-18.801 50.592-58.453V60.466c0-40.671-19.484-56.054-50.933-56.054h-80.667zm55.715-207.14h8.544c7.52 0 9.914 4.445 9.914 14.7v128.18c0 10.596-2.393 15.383-10.596 15.383h-7.862z"/>
                {/* R */}
                <path className="exit-modal__logo-letter" fill="#FFFFFF" d="M813.307 48.162h8.203c7.52 0 9.228 3.076 9.228 11.966v34.178c0 8.89-3.075 12.31-10.255 12.31h-7.176zm0 106.308h7.862c7.52 0 9.57 3.76 9.57 12.304v73.835c0 9.228 2.051 15.038 4.444 18.113H890.9v-1.708c-1.708-3.42-3.419-8.89-3.419-18.46V154.47c0-19.146-12.648-29.397-22.217-33.158 9.913-4.445 22.217-15.04 22.217-38.625V49.186c0-30.077-17.087-44.774-42.042-44.774h-88.532v254.31h56.401z"/>
                {/* I */}
                <path className="exit-modal__logo-letter" fill="#FFFFFF" d="M900.092 258.722h56.4V4.412h-56.4z"/>
                {/* V */}
                <path className="exit-modal__logo-letter" fill="#FFFFFF" d="M999.319 258.719h73.832l34.186-254.31h-54.349l-15.385 159.286-15.382-159.286h-59.473z"/>
                {/* E */}
                <path className="exit-modal__logo-letter" fill="#FFFFFF" d="M1113.586 4.412v254.31h107.674v-53.664h-51.958V154.47h39.996v-54.008h-39.996V57.05h49.906V4.412z"/>
                {/* R */}
                <path className="exit-modal__logo-letter" fill="#FFFFFF" d="M1285.454 48.162h8.2c7.52 0 9.228 3.076 9.228 11.966v34.178c0 8.89-3.075 12.31-10.255 12.31h-7.173zm0 106.308h7.859c7.52 0 9.57 3.76 9.57 12.304v73.835c0 9.228 2.051 15.038 4.444 18.113h55.716v-1.708c-1.708-3.42-3.419-8.89-3.419-18.46V154.47c0-19.146-12.645-29.397-22.217-33.158 9.913-4.445 22.217-15.04 22.217-38.625V49.186c0-30.077-17.087-44.774-42.042-44.774h-88.532v254.31h56.404z"/>
              </svg>
            </div>
