...
import type { NegotiationData } from './OfferNegotiation';
import './OfferNegotiation.css';

// eslint-disable-next-line @typescript-eslint/no-empty-function
const noop = () => {};

const baseNegotiation: NegotiationData = {
  id: 'neg-1',
  status: 'pending',
  dealerName: 'AutoNation Honda Costa Mesa',
  dealerId: 'dealer-1',
  vehicle: {
    year: 2025,
    make: 'Honda',
...
const meta: Meta<typeof OfferNegotiation> = {
  title: 'Organisms/OfferNegotiation',
...
\`\`\`
  ...
  argTypes: {
    negotiation: {
      description: 'The negotiation data including messages and status',
    },
    onSendCounter: {
      description: 'Callback when user sends a counter offer',
    },
    onAcceptOffer: {
      description: 'Callback when user accepts the dealer\'s offer',
    },
    onRejectOffer: {
      description: 'Callback when user rejects/declines negotiation',
    },
    onSendMessage: {
      description: 'Callback when user sends a message',
    },
    onClose: {
      description: 'Callback to close the negotiation panel',
    },
  },
};

export default meta;
type Story = StoryObj<typeof OfferNegotiation>;

export const PendingOffer: Story = {
  args: {
...
export const CounterReceived: Story = {
  args: {
    negotiation: {
      ...baseNegotiation,
      status: 'countered',
...
export const OfferRejected: Story = {
  args: {
    negotiation: {
      ...baseNegotiation,
      status: 'rejected',
...
export const LuxuryVehicleNegotiation: Story = {
  args: {
    negotiation: {
      id: 'neg-2',
      status: 'countered',
...
export const InteractiveDemo: Story = {
  args: {
    ...
    onSendCounter: (amount, message) => {
      console.log('Counter sent:', { amount, message });
