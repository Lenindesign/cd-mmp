import{j as e}from"./iframe-o0M0rmr0.js";const v=({children:u,variant:d="primary",size:c="medium",fullWidth:m=!1,loading:a=!1,disabled:t=!1,iconLeft:n,iconRight:s,as:f="button",href:r,target:p,className:b="",...l})=>{const i=["btn",`btn--${d}`,`btn--${c}`,m&&"btn--full-width",a&&"btn--loading",t&&"btn--disabled",b].filter(Boolean).join(" "),o=e.jsxs(e.Fragment,{children:[a&&e.jsx("span",{className:"btn__spinner","aria-hidden":"true",children:e.jsx("svg",{className:"btn__spinner-icon",viewBox:"0 0 24 24",fill:"none",children:e.jsx("circle",{cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeDasharray:"32",strokeDashoffset:"12"})})}),n&&!a&&e.jsx("span",{className:"btn__icon btn__icon--left",children:n}),e.jsx("span",{className:"btn__text",children:u}),s&&e.jsx("span",{className:"btn__icon btn__icon--right",children:s})]});return f==="a"&&r?e.jsx("a",{href:r,target:p,className:i,"aria-disabled":t||a,...l,children:o}):e.jsx("button",{type:"button",className:i,disabled:t||a,"aria-busy":a,...l,children:o})};v.__docgenInfo={description:`Button Component
