...
// With icon
<TextField label="Search" iconLeft={<SearchIcon />} />`,methods:[],displayName:"TextField",props:{label:{required:!1,tsType:{name:"string"},description:"Field label"},helperText:{required:!1,tsType:{name:"string"},description:"Helper text below the input"},error:{required:!1,tsType:{name:"string"},description:"Error message - shows error state when provided"},size:{required:!1,tsType:{name:"union",raw:"'small' | 'default' | 'large'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'default'"},{name:"literal",value:"'large'"}]},description:"Input size variant",defaultValue:{value:"'default'",computed:!1}},fullWidth:{required:!1,tsType:{name:"boolean"},description:"Full width input",defaultValue:{value:"false",computed:!1}},iconLeft:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Left icon/addon"},iconRight:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Right icon/addon"},wrapperClassName:{required:!1,tsType:{name:"string"},description:"Additional wrapper class",defaultValue:{value:"''",computed:!1}},className:{defaultValue:{value:"''",computed:!1},required:!1}},composes:["Omit"]};$.__docgenInfo={description:"",methods:[],displayName:"TextArea",props:{label:{required:!1,tsType:{name:"string"},description:""},helperText:{required:!1,tsType:{name:"string"},description:""},error:{required:!1,tsType:{name:"string"},description:""},fullWidth:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},wrapperClassName:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"''",computed:!1}},className:{defaultValue:{value:"''",computed:!1},required:!1}}};R.__docgenInfo={description:"",methods:[],displayName:"Select",props:{label:{required:!1,tsType:{name:"string"},description:""},helperText:{required:!1,tsType:{name:"string"},description:""},error:{required:!1,tsType:{name:"string"},description:""},fullWidth:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},wrapperClassName:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"''",computed:!1}},options:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:"{ value: string; label: string; disabled?: boolean }",signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}},{key:"disabled",value:{name:"boolean",required:!1}}]}}],raw:"Array<{ value: string; label: string; disabled?: boolean }>"},description:""},placeholder:{required:!1,tsType:{name:"string"},description:""},className:{defaultValue:{value:"''",computed:!1},required:!1}}};const{fn:V}=__STORYBOOK_MODULE_TEST__,re={title:"Atoms/TextField",component:l,parameters:{layout:"centered",docs:{description:{component:"Text input component with label, error handling, and icon support."}}},tags:["autodocs"],argTypes:{type:{control:"select",options:["text","email","password","number","tel","url"]},disabled:{control:"boolean"},required:{control:"boolean"},fullWidth:{control:"boolean"}},args:{onChange:V(),onBlur:V(),onFocus:V()},decorators:[s=>e.jsx("div",{style:{width:"320px"},children:e.jsx(s,{})})]},g={args:{label:"Full Name",placeholder:"Enter your name"}},v={args:{label:"Email Address",type:"email",value:"john@example.com"}},y={args:{label:"Email",placeholder:"Required field",required:!0}},T={args:{label:"Email",value:"invalid-email",error:"Please enter a valid email address"}},_={args:{label:"Password",type:"password",helperText:"Must be at least 8 characters"}},w={args:{label:"Disabled Field",value:"Cannot edit",disabled:!0}},j={args:{label:"Search",placeholder:"Search vehicles...",iconLeft:e.jsx(C,{size:18})}},S={args:{label:"Email",placeholder:"Enter email",iconRight:e.jsx(z,{size:18})}},q={render:()=>{const s=()=>{const[r,a]=p.useState(!1);return e.jsx(l,{label:"Password",type:r?"text":"password",placeholder:"Enter password",iconLeft:e.jsx(Y,{size:18}),iconRight:e.jsx("button",{type:"button",onClick:()=>a(!r),style:{background:"none",border:"none",cursor:"pointer",padding:0},children:r?e.jsx(B,{size:18}):e.jsx(H,{size:18})})})};return e.jsx(s,{})}},N={render:()=>e.jsx(R,{label:"Select Make",placeholder:"Choose a make",options:[{value:"toyota",label:"Toyota"},{value:"honda",label:"Honda"},{value:"ford",label:"Ford"},{value:"chevrolet",label:"Chevrolet"}]})},F={render:()=>e.jsx(R,{label:"Body Style",defaultValue:"suv",options:[{value:"sedan",label:"Sedan"},{value:"suv",label:"SUV"},{value:"truck",label:"Truck"}]})},E={render:()=>e.jsx($,{label:"Comments",placeholder:"Enter your comments...",rows:4})},k={render:()=>e.jsx($,{label:"Description",defaultValue:"This is a pre-filled description.",rows:4})},D={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[e.jsx(l,{label:"Full Name",placeholder:"John Doe",iconLeft:e.jsx(L,{size:18}),required:!0}),e.jsx(l,{label:"Email",type:"email",placeholder:"john@example.com",iconLeft:e.jsx(z,{size:18}),required:!0}),e.jsx(l,{label:"Phone",type:"tel",placeholder:"(555) 123-4567",iconLeft:e.jsx(I,{size:18})}),e.jsx(l,{label:"Budget",type:"number",placeholder:"35000",iconLeft:e.jsx(A,{size:18}),helperText:"Your maximum budget"})]})},W={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[e.jsx(l,{label:"Default",placeholder:"Default state"}),e.jsx(l,{label:"With Value",value:"Filled value"}),e.jsx(l,{label:"With Error",value:"Bad value",error:"This field has an error"}),e.jsx(l,{label:"With Helper",placeholder:"Enter value",helperText:"This is helper text"}),e.jsx(l,{label:"Disabled",value:"Cannot edit",disabled:!0}),e.jsx(l,{label:"Required",placeholder:"Required field",required:!0})]})};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Full Name',
...
}`,...W.parameters?.docs?.source}}};const le=["Default","WithValue","Required","WithError","WithHelperText","Disabled","WithIconLeft","WithIconRight","PasswordWithToggle","SelectDefault","SelectWithValue","TextAreaDefault","TextAreaWithValue","CompleteForm","AllStates"];export{W as AllStates,D as CompleteForm,g as Default,w as Disabled,q as PasswordWithToggle,y as Required,N as SelectDefault,F as SelectWithValue,E as TextAreaDefault,k as TextAreaWithValue,T as WithError,_ as WithHelperText,j as WithIconLeft,S as WithIconRight,v as WithValue,le as __namedExportsOrder,re as default};
