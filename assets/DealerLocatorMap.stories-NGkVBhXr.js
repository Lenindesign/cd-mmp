import{j as e}from"./iframe-BjFtNjKF.js";import{D as C,V as D,a as f}from"./DealerLocatorMap-CrvPghxh.js";import{g as b,s as x}from"./dealerService-DBjoBGu0.js";import"./preload-helper-PPVm8Dsz.js";import"./star-duLKwtpD.js";import"./createLucideIcon-DfJbe4c6.js";import"./chevron-right-Do8qR6Qb.js";import"./map-pin-BJy3MIC6.js";import"./phone-2QMepBQg.js";import"./navigation-BZMIS7Nz.js";import"./dollar-sign-p29fOy_K.js";import"./x-BU8ylF0A.js";import"./clock-CX1iZnGk.js";import"./index-B94bmRne.js";import"./index-DKe5mltf.js";import"./MakeOfferModal-Slpgvo24.js";import"./car-P_stiV5i.js";import"./user-DU9S-4ZO.js";import"./mail-Cpt2RoKW.js";import"./circle-check-big-BboQLxBh.js";import"./chevron-down-DH-u-O1_.js";const q={title:"Organisms/DealerLocatorMap",component:C,decorators:[a=>e.jsx("div",{style:{height:"600px",maxHeight:"600px",overflow:"hidden"},children:e.jsx(a,{})})],parameters:{layout:"padded",docs:{description:{component:`
# Dealer Locator Map
...
/>
\`\`\`
        `}}},tags:["autodocs"],argTypes:{vehicle:{description:"Vehicle information to display in the header",control:"object",table:{type:{summary:"VehicleInfo"},category:"Vehicle"}},initialLocation:{description:"Initial map center coordinates",control:"object",table:{type:{summary:"{ lat: number; lng: number }"},category:"Location"}},initialZipCode:{description:"Initial ZIP code for location display",control:"text",table:{type:{summary:"string"},category:"Location"}},showVehiclePreview:{description:"Show vehicle context header",control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:"true"},category:"Display"}},defaultView:{description:"Default view mode",control:{type:"radio",options:["map","list"]},table:{type:{summary:"'map' | 'list'"},defaultValue:{summary:"'list'"},category:"Display"}},maxResults:{description:"Maximum number of dealers to show",control:{type:"number",min:5,max:50},table:{type:{summary:"number"},defaultValue:{summary:"20"},category:"Display"}},cardVariant:{description:"Card display variant",control:{type:"radio",options:["full","compact"]},table:{type:{summary:"'full' | 'compact'"},defaultValue:{summary:"'full'"},category:"Display"}}}},s={year:2025,make:"Chevrolet",model:"Trax",msrp:21895,image:"https://d2kde5ohu8qb21.cloudfront.net/files/66466c119cbba1000852d79c/007-2025-chevrolet-trax-exterior-front-view.jpg",rating:8.5,bodyStyle:"SUV",mpg:28},V={year:2025,make:"Honda",model:"Accord",trim:"Sport",msrp:29610,image:"https://d2kde5ohu8qb21.cloudfront.net/files/679d37b47ff34400082301e7/19-2025-honda-accord-front-view.jpg",rating:9,bodyStyle:"Sedan",mpg:32},o={args:{vehicle:s,initialZipCode:"Miami, FL",showVehiclePreview:!0,defaultView:"list",maxResults:20}},i={args:{vehicle:s,initialZipCode:"Miami, FL",showVehiclePreview:!1,defaultView:"list"},parameters:{docs:{description:{story:"When embedded in a vehicle detail page, the vehicle preview can be hidden since the context is already clear."}}}},l={args:{vehicle:V,initialZipCode:"Los Angeles, CA",showVehiclePreview:!0,defaultView:"list"},parameters:{docs:{description:{story:"The component works with any vehicle data passed to it."}}}},n={args:{vehicle:s,initialZipCode:"Los Angeles, CA",showVehiclePreview:!0,defaultView:"list",cardVariant:"compact"},parameters:{docs:{description:{story:"Compact card variant for a more space-efficient dealer list. Shows essential info (name, inventory, price, rating, distance) in a condensed format."}}}},c={args:{vehicle:s,initialZipCode:"Miami, FL",showVehiclePreview:!0,maxResults:3},parameters:{docs:{description:{story:"Limit the number of dealers shown for a more focused view."}}}},d={render:()=>e.jsx(D,{vehicle:s}),parameters:{docs:{description:{story:"The vehicle context header shows the car being searched with key specs."}}}},p={render:()=>e.jsx(D,{vehicle:s,variant:"compact"}),parameters:{docs:{description:{story:"Compact variant used as a sticky header on mobile."}}}},m={render:()=>{const a=b(),r=x(a,"bestDeal")[0];return e.jsx("div",{style:{maxWidth:400,padding:16},children:e.jsx(f,{dealer:r,vehicleModel:"Trax",isSelected:!1})})},parameters:{docs:{description:{story:'Dealer card with the "Best Deal" badge, showing inventory count and price range.'}}}},h={render:()=>{const t=b()[1];return e.jsx("div",{style:{maxWidth:400,padding:16},children:e.jsx(f,{dealer:t,vehicleModel:"Trax",isSelected:!0})})},parameters:{docs:{description:{story:"Dealer card in selected state with blue border highlight."}}}},u={render:()=>{const a=b();return e.jsx("div",{style:{maxWidth:400,background:"white"},children:a.slice(0,3).map(t=>e.jsx(f,{dealer:t,vehicleModel:"Trax",variant:"compact"},t.id))})},parameters:{docs:{description:{story:"Compact dealer cards for dense list views."}}}},v={render:()=>{const a=b(),r=x(a,"bestDeal")[0];return e.jsx("div",{style:{height:500,position:"relative",background:"#f5f5f5",overflow:"hidden"},children:e.jsxs("div",{className:"dealer-bottom-sheet dealer-bottom-sheet--open",style:{position:"relative",transform:"none"},children:[e.jsx("button",{className:"dealer-bottom-sheet__close","aria-label":"Close dealer details",children:e.jsx("span",{children:"×"})}),e.jsxs("div",{className:"dealer-bottom-sheet__content",children:[e.jsxs("header",{className:"dealer-bottom-sheet__header",children:[e.jsx("span",{className:"dealer-card__badge",children:"BEST DEAL"}),e.jsx("h2",{className:"dealer-bottom-sheet__name",children:r.name}),e.jsxs("p",{className:"dealer-bottom-sheet__address",children:[r.address,e.jsx("br",{}),r.city,", ",r.state," ",r.zipCode]}),e.jsxs("div",{className:"dealer-bottom-sheet__rating",children:[e.jsx("span",{className:"dealer-card__rating-value",children:r.rating}),e.jsxs("span",{className:"dealer-card__rating-count",children:["(",r.reviewCount," reviews)"]})]})]}),e.jsx("p",{className:"dealer-bottom-sheet__hours",children:"Today: 9:00 AM - 9:00 PM"})]})]})})},parameters:{docs:{description:{story:"Mobile bottom sheet showing detailed dealer information and inventory."}}}},g={render:()=>{const a=b(),t=x(a,"bestDeal");return e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(350px, 1fr))",gap:16,padding:16,background:"#f5f5f5"},children:t.map(r=>e.jsx(f,{dealer:r,vehicleModel:"Trax"},r.id))})},parameters:{docs:{description:{story:"All dealer cards displayed in a responsive grid layout."}}}},y={args:{vehicle:s,initialZipCode:"Los Angeles, CA",showVehiclePreview:!0,defaultView:"list"},parameters:{layout:"fullscreen",viewport:{defaultViewport:"mobile1"},docs:{description:{story:"Mobile viewport with list/map toggle and compact header."}}}},w={args:{vehicle:s,initialZipCode:"Los Angeles, CA",showVehiclePreview:!0,defaultView:"list"},parameters:{layout:"fullscreen",viewport:{defaultViewport:"tablet"},docs:{description:{story:"Tablet viewport with split view layout."}}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
