import{r as h,j as r}from"./iframe-BqD4V8Qv.js";import{T as m}from"./triangle-alert-D0hd6Dqz.js";import{c as p}from"./createLucideIcon-Czx444dS.js";import"./preload-helper-PPVm8Dsz.js";const y=[["path",{d:"M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8",key:"5wwlr5"}],["path",{d:"M3 10a2 2 0 0 1 .709-1.528l7-6a2 2 0 0 1 2.582 0l7 6A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z",key:"r6nss1"}]],g=p("house",y);const x=[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8",key:"v9h5vc"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16",key:"3uifl3"}],["path",{d:"M8 16H3v5",key:"1cv678"}]],u=p("refresh-cw",x);class e extends h.Component{constructor(o){super(o),this.state={hasError:!1,error:null,errorInfo:null}}static getDerivedStateFromError(o){return{hasError:!0,error:o}}componentDidCatch(o,c){console.error("Error Boundary caught an error:",o,c),this.setState({error:o,errorInfo:c})}handleReset=()=>{this.setState({hasError:!1,error:null,errorInfo:null})};handleReload=()=>{window.location.reload()};handleGoHome=()=>{window.location.href="/"};render(){return this.state.hasError?this.props.fallback?this.props.fallback:r.jsx("div",{className:"error-boundary",children:r.jsxs("div",{className:"error-boundary__container",children:[r.jsx("div",{className:"error-boundary__icon",children:r.jsx(m,{size:64})}),r.jsxs("div",{className:"error-boundary__content",children:[r.jsx("h1",{className:"error-boundary__title",children:"Something Went Wrong"}),r.jsx("p",{className:"error-boundary__message",children:"We're sorry, but something unexpected happened. Our team has been notified and we're working on a fix."}),!1,r.jsxs("div",{className:"error-boundary__actions",children:[r.jsxs("button",{onClick:this.handleReset,className:"error-boundary__btn error-boundary__btn--secondary",children:[r.jsx(u,{size:18}),"Try Again"]}),r.jsxs("button",{onClick:this.handleReload,className:"error-boundary__btn error-boundary__btn--secondary",children:[r.jsx(u,{size:18}),"Reload Page"]}),r.jsxs("button",{onClick:this.handleGoHome,className:"error-boundary__btn error-boundary__btn--primary",children:[r.jsx(g,{size:18}),"Go to Homepage"]})]}),r.jsxs("p",{className:"error-boundary__help",children:["If the problem persists, please"," ",r.jsx("a",{href:"mailto:support@caranddriver.com",className:"error-boundary__link",children:"contact support"}),"."]})]})]})}):this.props.children}}e.__docgenInfo={description:"",methods:[{name:"handleReset",docblock:null,modifiers:[],params:[],returns:null},{name:"handleReload",docblock:null,modifiers:[],params:[],returns:null},{name:"handleGoHome",docblock:null,modifiers:[],params:[],returns:null}],displayName:"ErrorBoundary",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},fallback:{required:!1,tsType:{name:"ReactNode"},description:""}}};const E={title:"Atoms/ErrorBoundary",component:e,parameters:{layout:"fullscreen",docs:{description:{component:`
# ErrorBoundary
...
- Log errors to monitoring service in production
        `}}},tags:["autodocs"]},n=({shouldThrow:l=!0})=>{if(l)throw new Error("This is a simulated error for demonstration purposes");return r.jsxs("div",{style:{padding:"40px",textAlign:"center"},children:[r.jsx("h2",{children:"Component Rendered Successfully"}),r.jsx("p",{children:"No error occurred."})]})},t={parameters:{docs:{description:{story:"Default error boundary UI when an error is caught. Shows error message with recovery options."}}},render:()=>r.jsx(e,{children:r.jsx(n,{shouldThrow:!0})})},a={parameters:{docs:{description:{story:"When no error occurs, children render normally."}}},render:()=>r.jsx(e,{children:r.jsx(n,{shouldThrow:!1})})},f=()=>r.jsxs("div",{style:{padding:"60px",textAlign:"center",background:"var(--color-neutrals-7, #F4F5F6)",minHeight:"300px",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"16px"},children:[r.jsx("div",{style:{fontSize:"48px"},children:"🚗💨"}),r.jsx("h2",{style:{margin:0,fontFamily:"var(--font-heading, Poppins, sans-serif)",fontSize:"24px"},children:"Oops! Hit a speed bump"}),r.jsx("p",{style:{margin:0,color:"var(--color-neutrals-4, #6E7481)",maxWidth:"400px"},children:"We encountered an unexpected issue. Please try refreshing the page."}),r.jsx("button",{onClick:()=>window.location.reload(),className:"cta cta--primary cta--default",style:{marginTop:"8px"},children:"Refresh Page"})]}),s={parameters:{docs:{description:{story:"Error boundary with a custom fallback component that matches the application theme."}}},render:()=>r.jsx(e,{fallback:r.jsx(f,{}),children:r.jsx(n,{shouldThrow:!0})})},i={parameters:{docs:{description:{story:"Multiple error boundaries can be nested. Only the nearest boundary catches the error."}}},render:()=>r.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"24px",padding:"24px"},children:[r.jsxs("div",{children:[r.jsx("h3",{style:{marginBottom:"16px"},children:"Section 1 (Error)"}),r.jsx(e,{children:r.jsx(n,{shouldThrow:!0})})]}),r.jsxs("div",{children:[r.jsx("h3",{style:{marginBottom:"16px"},children:"Section 2 (Working)"}),r.jsx(e,{children:r.jsx(n,{shouldThrow:!1})})]})]})},d={parameters:{docs:{description:{story:"Implementation guide for using ErrorBoundary in your application."}}},render:()=>r.jsxs("div",{style:{padding:"40px",maxWidth:"800px",margin:"0 auto"},children:[r.jsx("h1",{style:{marginBottom:"24px"},children:"ErrorBoundary Implementation Guide"}),r.jsxs("section",{style:{marginBottom:"32px"},children:[r.jsx("h2",{children:"Basic Usage"}),r.jsx("pre",{style:{background:"#1d1d1f",color:"#f5f5f7",padding:"16px",borderRadius:"8px",overflow:"auto"},children:`import ErrorBoundary from '@/components/ErrorBoundary';
