import{G as t,j as e,r as x,g as b,e as u,c as v,a as D}from"./iframe-uGVaIJRM.js";import"./preload-helper-PPVm8Dsz.js";const w={title:"Components/GoogleOneTap",component:t,parameters:{layout:"fullscreen",docs:{description:{component:`
...
- \`high_intent_page_view\` - When user visits MMP or rankings pages
        `}}},tags:["autodocs"],argTypes:{pageType:{control:"select",options:["mmp","rankings","comparison","pricing","other"],description:"Page type for CDP tracking"},promptDelay:{control:{type:"number",min:0,max:5e3,step:100},description:"Delay before showing prompt (ms)"},isAuthenticated:{control:"boolean",description:"Whether user is already authenticated"},debug:{control:"boolean",description:"Enable debug logging"}}},c=({children:r,showControls:s=!0})=>{const[n,m]=x.useState(null),[o,g]=x.useState(null);x.useEffect(()=>{m(b()),g(u());const h=()=>{m(b()),g(u())};window.addEventListener("storage",h);const y=setInterval(()=>{m(b()),g(u())},1e3);return()=>{window.removeEventListener("storage",h),clearInterval(y)}},[]);const f=()=>{v(),m(null)},T=()=>{D(),g(u())};return s?e.jsxs("div",{style:{padding:"2rem",fontFamily:"system-ui, sans-serif"},children:[e.jsxs("div",{style:{marginBottom:"2rem",padding:"1rem",background:"#f5f5f5",borderRadius:"8px",border:"1px solid #e0e0e0"},children:[e.jsx("h3",{style:{margin:"0 0 1rem 0",fontSize:"1rem",fontWeight:600},children:"Google One Tap Demo"}),e.jsxs("div",{style:{padding:"0.75rem",background:"#fff3cd",border:"1px solid #ffc107",borderRadius:"4px",marginBottom:"1rem",fontSize:"0.875rem"},children:[e.jsx("strong",{children:"Note:"})," VITE_GOOGLE_CLIENT_ID is not set. Add it to your .env file to enable Google One Tap."]}),e.jsxs("div",{style:{display:"flex",gap:"1rem",alignItems:"center",flexWrap:"wrap"},children:[e.jsxs("div",{style:{padding:"0.5rem 1rem",background:n?"#d4edda":"#f8d7da",borderRadius:"4px",fontSize:"0.875rem"},children:["Status: ",n?`Signed in as ${n.email}`:"Not signed in"]}),n&&e.jsx("button",{onClick:f,style:{padding:"0.5rem 1rem",background:"#dc3545",color:"white",border:"none",borderRadius:"4px",cursor:"pointer",fontSize:"0.875rem"},children:"Sign Out"}),e.jsx("button",{onClick:T,style:{padding:"0.5rem 1rem",background:"#6c757d",color:"white",border:"none",borderRadius:"4px",cursor:"pointer",fontSize:"0.875rem"},children:"Clear CDP Data"})]}),n&&e.jsxs("div",{style:{marginTop:"1rem",display:"flex",alignItems:"center",gap:"0.75rem"},children:[n.picture&&e.jsx("img",{src:n.picture,alt:n.name,style:{width:40,height:40,borderRadius:"50%"}}),e.jsxs("div",{children:[e.jsx("div",{style:{fontWeight:500},children:n.name}),e.jsx("div",{style:{fontSize:"0.875rem",color:"#666"},children:n.email})]})]})]}),o&&(o.events.length>0||o.registration||o.highIntentViews.length>0)&&e.jsxs("div",{style:{marginBottom:"2rem",padding:"1rem",background:"#e8f4f8",borderRadius:"8px",border:"1px solid #b8daff",fontSize:"0.875rem"},children:[e.jsx("h4",{style:{margin:"0 0 0.75rem 0",fontSize:"0.875rem",fontWeight:600},children:"CDP Data (localStorage)"}),o.registration&&e.jsxs("div",{style:{marginBottom:"0.5rem"},children:[e.jsx("strong",{children:"Registration Source:"})," ",o.registration.source]}),e.jsxs("div",{style:{marginBottom:"0.5rem"},children:[e.jsx("strong",{children:"High-Intent Views:"})," ",o.highIntentViews.length]}),e.jsxs("div",{children:[e.jsx("strong",{children:"Recent Events:"}),e.jsx("ul",{style:{margin:"0.25rem 0 0 1.5rem",padding:0},children:o.events.slice(-5).map((h,y)=>e.jsx("li",{children:h.event_type},y))})]})]}),r]}):e.jsx(e.Fragment,{children:r})},a={args:{pageType:"mmp",vehicleInfo:{year:2024,make:"Honda",model:"CR-V"},promptDelay:500,isAuthenticated:!1,debug:!0},render:r=>e.jsxs(c,{children:[e.jsx(t,{...r}),e.jsxs("div",{style:{padding:"2rem",background:"white",borderRadius:"8px",border:"1px solid #e0e0e0"},children:[e.jsx("h2",{style:{margin:"0 0 1rem 0"},children:"2024 Honda CR-V"}),e.jsxs("p",{style:{color:"#666",margin:0},children:["The Google One Tap prompt will appear in the top-right corner after ",r.promptDelay,"ms."]})]})]})},i={args:{pageType:"mmp",isAuthenticated:!0},render:r=>e.jsxs(c,{children:[e.jsx(t,{...r}),e.jsxs("div",{style:{padding:"2rem",background:"white",borderRadius:"8px",border:"1px solid #e0e0e0"},children:[e.jsx("h2",{style:{margin:"0 0 1rem 0"},children:"Authenticated User"}),e.jsx("p",{style:{color:"#666",margin:0},children:"Google One Tap will not show because the user is already authenticated."})]})]})},d={args:{pageType:"rankings",promptDelay:500,isAuthenticated:!1,debug:!0},render:r=>e.jsxs(c,{children:[e.jsx(t,{...r}),e.jsxs("div",{style:{padding:"2rem",background:"white",borderRadius:"8px",border:"1px solid #e0e0e0"},children:[e.jsx("h2",{style:{margin:"0 0 1rem 0"},children:"Best SUVs Rankings"}),e.jsx("p",{style:{color:"#666",margin:0},children:"This simulates the Rankings page context. CDP will track this as a high-intent page view."})]})]})},l={args:{pageType:"mmp",promptDelay:2e3,isAuthenticated:!1,debug:!0},render:r=>e.jsxs(c,{children:[e.jsx(t,{...r}),e.jsxs("div",{style:{padding:"2rem",background:"white",borderRadius:"8px",border:"1px solid #e0e0e0"},children:[e.jsx("h2",{style:{margin:"0 0 1rem 0"},children:"Custom Delay Demo"}),e.jsxs("p",{style:{color:"#666",margin:0},children:["The Google One Tap prompt will appear after ",r.promptDelay,"ms (2 seconds)."]})]})]})},p={args:{pageType:"mmp",vehicleInfo:{year:2024,make:"Toyota",model:"RAV4"},promptDelay:500,isAuthenticated:!1,debug:!0},render:r=>e.jsxs(c,{children:[e.jsx(t,{...r,onSuccess:s=>{console.log("Sign-in successful:",s),alert(`Welcome, ${s.name}!`)},onError:s=>{console.error("Sign-in error:",s)},onDismiss:s=>{console.log("Prompt dismissed:",s)}}),e.jsxs("div",{style:{padding:"2rem",background:"white",borderRadius:"8px",border:"1px solid #e0e0e0"},children:[e.jsx("h2",{style:{margin:"0 0 1rem 0"},children:"2024 Toyota RAV4"}),e.jsx("p",{style:{color:"#666",margin:0},children:"This demo has callbacks configured. Check the console for events."})]})]})};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    pageType: 'mmp',
    vehicleInfo: {
      year: 2024,
