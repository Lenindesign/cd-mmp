...
/>
\`\`\`
        `}}},tags:["autodocs"],argTypes:{variant:{control:"radio",options:["large","medium","small"],description:"Card size variant"}}},p={args:{thumbnailUrl:t?.image||"",thumbnailAlt:`${t?.year} ${t?.make} ${t?.model}`,title:`${t?.year} ${t?.make} ${t?.model} Carrera GTS: Track Test at Laguna Seca`,duration:"12:34",variant:"large"}},h={args:{thumbnailUrl:l?.image||"",thumbnailAlt:`${l?.year} ${l?.make} ${l?.model}`,title:`${l?.year} ${l?.make} ${l?.model} Z06: America's Supercar`,overlayText:"The most powerful naturally aspirated V8 ever in a production car.",variant:"large"}},v={args:{thumbnailUrl:n?.image||"",thumbnailAlt:`${n?.year} ${n?.make} ${n?.model}`,title:`${n?.year} ${n?.make} ${n?.model} Competition: Is It Worth the Premium?`,duration:"8:15",label:"Video Review",author:"K.C. Colwell",date:"Dec 20, 2024",variant:"large"}},g={args:{thumbnailUrl:o?.image||"",thumbnailAlt:`${o?.year} ${o?.make} ${o?.model}`,title:`${o?.year} ${o?.make} ${o?.model} Dark Horse: 500 HP of American Muscle`,duration:"10:45",sponsor:"Car and Driver",variant:"medium"}},$={args:{thumbnailUrl:s?.image||"",thumbnailAlt:`${s?.year} ${s?.make} ${s?.model}`,title:`${s?.year} ${s?.make} ${s?.model} Plaid: 0-60 Test`,duration:"3:45",variant:"small"}},y={args:{thumbnailUrl:d?.image||"",thumbnailAlt:`${d?.year} ${d?.make} ${d?.model}`,title:`${d?.year} ${d?.make} ${d?.model}: Supercar Dreams`,duration:"15:00",sponsor:"Car and Driver + Lamborghini",label:"Sponsored",variant:"large"}},b={args:{thumbnailUrl:t?.image||"",thumbnailAlt:"Watch Next",title:"Watch Next: Best Sports Cars of 2025",variant:"medium"}},f={render:()=>{const e=U[0],r=U.slice(1,4);return a.jsxs("div",{style:{display:"grid",gridTemplateColumns:"2fr 1fr",gap:"24px",maxWidth:"1200px"},children:[a.jsx(m,{thumbnailUrl:e?.image||"",thumbnailAlt:`${e?.year} ${e?.make} ${e?.model}`,title:`${e?.year} ${e?.make} ${e?.model}: The Ultimate Track Test`,duration:"18:34",overlayText:`${e?.horsepower||0} HP of Pure Performance`,variant:"large"}),a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:r.map((i,c)=>a.jsx(m,{thumbnailUrl:i.image,thumbnailAlt:`${i.year} ${i.make} ${i.model}`,title:`${i.year} ${i.make} ${i.model}: ${c===0?"First Drive":c===1?"Comparison Test":"Full Review"}`,duration:["6:30","8:15","5:45"][c],variant:"small"},i.id))})]})}},x={render:()=>a.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:"24px",maxWidth:"1200px"},children:N.slice(0,3).map((e,r)=>a.jsx(m,{thumbnailUrl:e.image,thumbnailAlt:`${e.year} ${e.make} ${e.model}`,title:`${e.year} ${e.make} ${e.model}: ${r===0?"Off-Road Adventure Test":r===1?"Family Road Trip Review":"Towing Capacity Showdown"}`,duration:["12:34","8:15","10:30"][r],author:["Dan Edmunds","Austin Irwin","Eric Stafford"][r],date:`Dec ${22-r}, 2024`,variant:"medium"},e.id))})},k={render:()=>a.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(2, 1fr)",gap:"24px",maxWidth:"1000px"},children:R.slice(0,4).map((e,r)=>a.jsx(m,{thumbnailUrl:e.image,thumbnailAlt:`${e.year} ${e.make} ${e.model}`,title:`${e.year} ${e.make} ${e.model}: ${r===0?"Towing 10,000 lbs Up a Mountain":r===1?"Work Truck vs Luxury Truck":r===2?"Electric Truck Range Test":"Best Truck for Your Money"}`,duration:["15:20","12:45","18:30","9:15"][r],overlayText:e.fuelType==="Electric"?"Electric Truck Revolution":void 0,variant:"large"},e.id))})},T={render:()=>a.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(4, 1fr)",gap:"16px",maxWidth:"1200px"},children:P.slice(0,4).map((e,r)=>a.jsx(m,{thumbnailUrl:e.image,thumbnailAlt:`${e.year} ${e.make} ${e.model}`,title:`${e.year} ${e.make} ${e.model}`,duration:["5:30","6:15","4:45","7:00"][r],label:e.editorsChoice?"Editor's Pick":e.tenBest?"10Best":void 0,variant:"small"},e.id))})};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:"{\n  args: {\n    thumbnailUrl: porsche911?.image || '',\n    thumbnailAlt: `${porsche911?.year} ${porsche911?.make} ${porsche911?.model}`,\n    title: `${porsche911?.year} ${porsche911?.make} ${porsche911?.model} Carrera GTS: Track Test at Laguna Seca`,\n    duration: '12:34',\n    variant: 'large'\n  }\n}",...p.parameters?.docs?.source}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:"{\n  args: {\n    thumbnailUrl: chevyCorvette?.image || '',\n    thumbnailAlt: `${chevyCorvette?.year} ${chevyCorvette?.make} ${chevyCorvette?.model}`,\n    title: `${chevyCorvette?.year} ${chevyCorvette?.make} ${chevyCorvette?.model} Z06: America's Supercar`,\n    overlayText: 'The most powerful naturally aspirated V8 ever in a production car.',\n    variant: 'large'\n  }\n}",...h.parameters?.docs?.source}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...T.parameters?.docs?.source}}};const B=["Default","WithOverlayText","WithLabel","MediumSize","SmallSize","WithSponsor","MinimalInfo","VideoGrid","HorizontalFeed","TruckShowcase","SedanComparison"];export{p as Default,x as HorizontalFeed,g as MediumSize,b as MinimalInfo,T as SedanComparison,$ as SmallSize,k as TruckShowcase,f as VideoGrid,v as WithLabel,h as WithOverlayText,y as WithSponsor,B as __namedExportsOrder,z as default};
