import{j as e}from"./iframe-CKsQctQx.js";import{T as o,H as i,P as r,Q as y,L as u,a as t,D as f}from"./TextBlock-CuHdjnVv.js";import"./preload-helper-PPVm8Dsz.js";const w={title:"Resin Components/TextBlock",component:o,parameters:{layout:"padded",docs:{description:{component:`
## Text Block
...
\`\`\`
        `}}},tags:["autodocs"],argTypes:{size:{control:"radio",options:["small","medium","large"],description:"Text size variant"},maxWidth:{control:"radio",options:["narrow","medium","wide","full"],description:"Maximum width constraint"},dropCap:{control:"boolean",description:"Enable drop cap on first paragraph"},relaxedSpacing:{control:"boolean",description:"Add extra spacing between paragraphs"}}},n={args:{size:"medium",maxWidth:"medium",dropCap:!1,relaxedSpacing:!1},render:a=>e.jsxs(o,{...a,children:[e.jsx(i,{level:1,children:"2025 Honda Accord Review: The Benchmark Sedan"}),e.jsx(r,{lead:!0,children:"The Honda Accord has long been the benchmark for midsize sedans, and the 2025 model continues that tradition with refinements to its already excellent formula."}),e.jsx(r,{children:"With a comfortable ride, spacious interior, and impressive fuel economy, it remains one of our top picks in the segment. The Accord offers two powertrain choices: a turbocharged 1.5-liter four-cylinder making 192 horsepower, or a hybrid system that combines a 2.0-liter four-cylinder with two electric motors for 204 horsepower."}),e.jsx(r,{children:"Both options deliver smooth, refined power delivery that makes the Accord a pleasure to drive in any situation, from highway cruising to city commuting."})]})},s={args:{size:"large",maxWidth:"medium",dropCap:!0,relaxedSpacing:!0},render:a=>e.jsxs(o,{...a,children:[e.jsx(r,{children:"The automotive landscape is changing rapidly, with electric vehicles now accounting for a significant portion of new car sales. But traditional sedans like the Honda Accord continue to prove their worth, offering a combination of efficiency, comfort, and value that's hard to beat."}),e.jsx(r,{children:"In our comprehensive testing, the 2025 Accord demonstrated why it remains a favorite among both critics and consumers. Its refined powertrain options, spacious interior, and impressive list of standard features make it a compelling choice in a crowded market."})]})},d={args:{size:"medium",maxWidth:"medium"},render:a=>e.jsxs(o,{...a,children:[e.jsx(i,{level:2,children:"What the Experts Say"}),e.jsx(r,{children:"Industry experts consistently praise the Accord for its balanced approach to performance and efficiency. The hybrid model, in particular, has garnered attention for its seamless power delivery."}),e.jsx(y,{cite:"Car and Driver",children:"The Accord Hybrid is the best midsize sedan we've tested this year. Its combination of fuel efficiency, driving dynamics, and interior quality sets a new standard for the segment."}),e.jsx(r,{children:"This praise is well-deserved. In our testing, the Accord Hybrid achieved an impressive 47 mpg combined, while still delivering enough power for confident highway merging and passing maneuvers."})]})},c={args:{size:"medium",maxWidth:"medium"},render:a=>e.jsxs(o,{...a,children:[e.jsx(i,{level:2,children:"Key Features"}),e.jsx(r,{children:"The 2025 Honda Accord comes packed with features that make it stand out in the competitive midsize sedan segment:"}),e.jsx(u,{items:["Honda Sensing suite of driver-assistance features (standard)","12.3-inch touchscreen infotainment system","Wireless Apple CarPlay and Android Auto","Heated front seats (EX and above)","Adaptive cruise control with low-speed follow"]}),e.jsx(i,{level:3,children:"Available Powertrains"}),e.jsx(u,{ordered:!0,items:["1.5L Turbocharged 4-cylinder (192 hp) - LX, EX, Sport","2.0L Hybrid (204 hp) - Sport-L Hybrid, Touring Hybrid"]})]})},l={args:{size:"medium",maxWidth:"medium"},render:a=>e.jsxs(o,{...a,children:[e.jsx(i,{level:2,children:"Important Considerations"}),e.jsxs(t,{variant:"success",children:[e.jsx("strong",{children:"Editors' Choice:"})," The 2025 Honda Accord earns our Editors' Choice award for its exceptional combination of comfort, efficiency, and value."]}),e.jsx(r,{children:"Before making your purchase decision, there are several factors to consider about the 2025 Accord."}),e.jsxs(t,{variant:"info",children:[e.jsx("strong",{children:"Fuel Economy:"})," The Accord Hybrid achieves up to 51 mpg city and 44 mpg highway, making it one of the most efficient sedans in its class."]}),e.jsxs(t,{variant:"warning",children:[e.jsx("strong",{children:"Note:"})," The Sport trim with the 2.0T engine has been discontinued for 2025. If you want more power, the hybrid is now your only option."]}),e.jsxs(t,{variant:"tip",children:[e.jsx("strong",{children:"Pro Tip:"})," Consider the EX-L trim for the best balance of features and value. It includes leather seats, a power moonroof, and the full Honda Sensing suite."]})]})},h={args:{size:"medium",maxWidth:"medium"},render:a=>e.jsxs(o,{...a,children:[e.jsx(i,{level:2,children:"Section One: Design"}),e.jsx(r,{children:"The 2025 Accord features a sleek, modern design that balances sophistication with sportiness. The front fascia is bold without being aggressive, while the roofline flows smoothly into a subtle rear spoiler."}),e.jsx(f,{variant:"line"}),e.jsx(i,{level:2,children:"Section Two: Performance"}),e.jsx(r,{children:"On the road, the Accord delivers a composed, confident driving experience. The steering is precise, the brakes are strong, and the suspension strikes an excellent balance between comfort and control."}),e.jsx(f,{variant:"dots"}),e.jsx(i,{level:2,children:"Section Three: Value"}),e.jsx(r,{children:"Starting at $28,990, the Accord offers excellent value for money. Even the base LX trim includes features like adaptive cruise control, lane-keeping assist, and a 7-inch touchscreen."})]})},m={args:{size:"medium",maxWidth:"medium",htmlContent:`
    ...
    `}},p={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"48px"},children:[e.jsxs("div",{children:[e.jsx("h3",{style:{marginBottom:"16px",color:"#6b7280"},children:"Small"}),e.jsx(o,{size:"small",maxWidth:"full",children:e.jsx(r,{children:"The Honda Accord has long been the benchmark for midsize sedans. With a comfortable ride, spacious interior, and impressive fuel economy, it remains one of our top picks."})})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{marginBottom:"16px",color:"#6b7280"},children:"Medium (Default)"}),e.jsx(o,{size:"medium",maxWidth:"full",children:e.jsx(r,{children:"The Honda Accord has long been the benchmark for midsize sedans. With a comfortable ride, spacious interior, and impressive fuel economy, it remains one of our top picks."})})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{marginBottom:"16px",color:"#6b7280"},children:"Large"}),e.jsx(o,{size:"large",maxWidth:"full",children:e.jsx(r,{children:"The Honda Accord has long been the benchmark for midsize sedans. With a comfortable ride, spacious interior, and impressive fuel economy, it remains one of our top picks."})})]})]})},g={render:()=>e.jsxs(o,{size:"medium",maxWidth:"medium",dropCap:!0,relaxedSpacing:!0,children:[e.jsx(i,{level:1,children:"2025 Honda Accord Review"}),e.jsx(r,{lead:!0,children:"The Honda Accord continues to set the standard for midsize sedans with its exceptional blend of comfort, efficiency, and value."}),e.jsx(r,{children:"For decades, the Honda Accord has been synonymous with reliability and practicality. The 2025 model year brings subtle refinements that enhance an already excellent formula, cementing the Accord's position as one of the best sedans money can buy."}),e.jsx(i,{level:2,children:"Design and Styling"}),e.jsx(r,{children:"The exterior design strikes a perfect balance between sophistication and sportiness. A bold front grille, sleek LED headlights, and a flowing roofline give the Accord a presence that stands out in parking lots and on highways alike."}),e.jsx(y,{cite:"Car and Driver Design Team",children:"Honda has mastered the art of evolutionary design. The Accord looks fresh without alienating loyal customers who appreciate its timeless appeal."}),e.jsx(i,{level:2,children:"Performance"}),e.jsx(r,{children:"Two powertrain options are available for 2025:"}),e.jsx(u,{items:["1.5-liter turbocharged four-cylinder (192 hp, 192 lb-ft)","2.0-liter hybrid system (204 hp combined)"]}),e.jsx(t,{variant:"tip",children:"If fuel efficiency is your priority, the hybrid is the clear choice, achieving up to 51 mpg in city driving."}),e.jsx(f,{variant:"dots"}),e.jsx(i,{level:2,children:"The Verdict"}),e.jsx(r,{children:"The 2025 Honda Accord earns our highest recommendation. Whether you choose the efficient hybrid or the peppy turbocharged engine, you're getting one of the best sedans available today."}),e.jsxs(t,{variant:"success",children:[e.jsx("strong",{children:"Editors' Choice Award:"})," The Accord's combination of quality, value, and driving enjoyment makes it an easy choice for our Editors' Choice award."]})]})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'medium',
    maxWidth: 'medium',
    dropCap: false,
...
}`,...g.parameters?.docs?.source}}};const H=["Default","WithDropCap","WithQuote","WithLists","WithHighlights","WithDividers","HTMLContent","AllSizes","FullArticle"];export{p as AllSizes,n as Default,g as FullArticle,m as HTMLContent,h as WithDividers,s as WithDropCap,l as WithHighlights,c as WithLists,d as WithQuote,H as __namedExportsOrder,w as default};
