import{B as p}from"./BigStoryCard-CLHcGQtL.js";import{v as s}from"./index-Dto8T7jp.js";import"./iframe-DFukfoFU.js";import"./preload-helper-PPVm8Dsz.js";const a=s.find(e=>e.make==="Honda"&&e.model==="Accord"),r=s.find(e=>e.make==="BMW"&&e.model==="3 Series"),o=s.find(e=>e.make==="Ford"&&e.model==="Mustang"),t=s.find(e=>e.make==="Porsche"&&e.model==="911"),i=s.find(e=>e.make==="Tesla"&&e.model==="Model 3"),n=s.find(e=>e.make==="Toyota"&&e.model==="Corolla"),S={title:"Resin Components/BigStoryCard",component:p,parameters:{layout:"padded",docs:{description:{component:`
## Big Story Card
