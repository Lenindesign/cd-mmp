import{j as a}from"./iframe-CcR_LnTn.js";import{A as t}from"./ArticleCard-D-xe-4jd.js";import{v as g,s as $,a as h,t as v,c as y}from"./index-Dto8T7jp.js";import"./preload-helper-PPVm8Dsz.js";const r=g.find(e=>e.make==="Honda"&&e.model==="Civic"),i=g.find(e=>e.make==="Toyota"&&e.model==="Highlander"),o=g.find(e=>e.make==="Ford"&&e.model==="F-150"),k={title:"Resin Components/ArticleCard",component:t,parameters:{layout:"padded",docs:{description:{component:`
## Article Card
