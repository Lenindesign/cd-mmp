...
Shows lease-specific sections: monthly payment, cash-down table by trim, mileage terms.`,...s.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
...
Shows cash-specific rendering: "cash back" suffix, different expert tip.`,...c.parameters?.docs?.description}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
...
}`,...l.parameters?.docs?.source},description:{story:`**Conversion B with Military incentive** — shows the restricted eligibility UI.
The eligibility box renders with a "Military / Veterans" badge and restricted styling.`,...l.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
...
Used in the Hero component for info-only display. Shows "Shop on Marketplace" CTA.`,...p.parameters?.docs?.description}}};const ee=["ReviewAll","ConversionB","ConversionBLease","ConversionBCash","ConversionBMilitary","ConversionBFallback","ConversionBNoForm"];export{a as ConversionB,c as ConversionBCash,d as ConversionBFallback,s as ConversionBLease,l as ConversionBMilitary,p as ConversionBNoForm,r as ReviewAll,ee as __namedExportsOrder,J as default};
