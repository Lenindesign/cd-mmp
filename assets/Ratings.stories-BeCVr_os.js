...
}`,...v.parameters?.docs?.source},description:{story:"C/D Score - The prominent Car and Driver score display with verified badge.",...v.parameters?.docs?.description}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  render: () => <div style={styles.container}>
      <div style={styles.section}>
...
}`,...f.parameters?.docs?.source},description:{story:"Star ratings for community/user reviews.",...f.parameters?.docs?.description}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: () => <div style={styles.container}>
      <div style={styles.section}>
...
}`,...h.parameters?.docs?.source},description:{story:"Numeric ratings for staff/editorial scores.",...h.parameters?.docs?.description}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  render: () => <div style={styles.container}>
      <div style={styles.section}>
